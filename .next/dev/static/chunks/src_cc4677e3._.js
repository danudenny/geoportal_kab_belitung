...
"[project]/src/hooks/useDuckDB.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
var __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$duckdb$2f$duckdb$2d$wasm$2f$dist$2f$duckdb$2d$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/node_modules/@duckdb/duckdb-wasm/dist/duckdb-browser.mjs [app-client] (ecmascript)");
...
const JSDELIVR_BUNDLES = __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$duckdb$2f$duckdb$2d$wasm$2f$dist$2f$duckdb$2d$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["getJsDelivrBundles"]();
const useDuckDB = ()=>{
    _s();
    ...
    (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useEffect"])({
        "useDuckDB.useEffect": ()=>{
            const initDB = {
                "useDuckDB.useEffect.initDB": async ()=>{
                    try {
                        // Select bundle
                        const bundle = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$duckdb$2f$duckdb$2d$wasm$2f$dist$2f$duckdb$2d$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["selectBundle"](JSDELIVR_BUNDLES);
                        const worker = await __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$duckdb$2f$duckdb$2d$wasm$2f$dist$2f$duckdb$2d$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["createWorker"](bundle.mainWorker);
                        const logger = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$duckdb$2f$duckdb$2d$wasm$2f$dist$2f$duckdb$2d$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["ConsoleLogger"]();
                        const newDB = new __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f40$duckdb$2f$duckdb$2d$wasm$2f$dist$2f$duckdb$2d$browser$2e$mjs__$5b$app$2d$client$5d$__$28$ecmascript$29$__["AsyncDuckDB"](logger, worker);
...
_s(useDuckDB, "lDUzG4oyoNPq6GLGBt4sstE1YTs=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
"[project]/src/hooks/useSpatialAnalysis.ts [app-client] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
const useSpatialAnalysis = (db)=>{
    ...
    const runAnalysis = (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$index$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useCallback"])({
        "useSpatialAnalysis.useCallback[runAnalysis]": async (uploadedFile, layerId = 'rtrw')=>{
            if (!db) {
            ...
            try {
                ...
                // 2. Read and Reproject Features
                // We need to ensure both datasets are in the same CRS (EPSG:3857) for accurate area calculation (meters)
                // The API returns EPSG:3857.
                // We'll use OpenLayers to read the input (likely 4326) and output 3857.
                ...
                // Generate GeoJSON in 3857 for DuckDB
                const reprojectedGeoJSON = format.writeFeaturesObject(features);
                // Calculate BBOX from reprojected features for the API request
                let minx = Infinity, miny = Infinity, maxx = -Infinity, maxy = -Infinity;
                features.forEach({
                    "useSpatialAnalysis.useCallback[runAnalysis]": (f)=>{
                ...
                }["useSpatialAnalysis.useCallback[runAnalysis]"]);
                // 3. Fetch Reference Data (RTRW)
                // bbox is now in 3857, which matches what the API expects
                ...
                // Create Tables
                // Now both files are in EPSG:3857 coordinates (meters)
                await db.registerFileText('upload.json', JSON.stringify(reprojectedGeoJSON));
                ...
                const resultRows = resultArrow.toArray().map({
                    "useSpatialAnalysis.useCallback[runAnalysis].resultRows": (row)=>row.toJSON()
                }["useSpatialAnalysis.useCallback[runAnalysis].resultRows"]);
                // 6. Calculate Totals & Percentages
                const totalAreaSqm = resultRows.reduce({
                    "useSpatialAnalysis.useCallback[runAnalysis].totalAreaSqm": (sum, row)=>sum + Number(row.area_sqm)
                }["useSpatialAnalysis.useCallback[runAnalysis].totalAreaSqm"], 0);
                const finalResults = resultRows.map({
                    "useSpatialAnalysis.useCallback[runAnalysis].finalResults": (row)=>({
                            category: row.category,
                            areaHa: Number(row.area_sqm) / 10000,
                            percentage: Number(row.area_sqm) / totalAreaSqm * 100
                        })
                }["useSpatialAnalysis.useCallback[runAnalysis].finalResults"]);
...
_s(useSpatialAnalysis, "eyLwNgfcYrUmVi7h2b7uOKwtnQw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDuckDB$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useDuckDB.ts [app-client] (ecmascript)");
var __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpatialAnalysis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__ = __turbopack_context__.i("[project]/src/hooks/useSpatialAnalysis.ts [app-client] (ecmascript)");
...
const AnalysisPanel = ({ uploadedFiles, close })=>{
    _s();
    const { db, isLoading: isDbLoading } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDuckDB$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDuckDB"])();
    const { runAnalysis, isAnalyzing, results, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpatialAnalysis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpatialAnalysis"])(db);
    ...
    // Helper to get color
    const getColor = (name)=>{
        const item = __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$constants$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["polaRuangColorSet"].find((c)=>c.namobj === name);
                ...
                children: [
                    /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("div", {
                        ...
                        children: [
                            ...
                            isDbLoading && /*#__PURE__*/ (0, __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$dist$2f$compiled$2f$react$2f$jsx$2d$dev$2d$runtime$2e$js__$5b$app$2d$client$5d$__$28$ecmascript$29$__["jsxDEV"])("p", {
...
_s(AnalysisPanel, "N2KXbaMUYXIynbpFyxMHWnLX8KU=", false, function() {
    return [
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useDuckDB$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useDuckDB"],
        __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useSpatialAnalysis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useSpatialAnalysis"]
    ];
});
_c = AnalysisPanel;
...
_s(Home, "oV/X55KocNXoRNp5wLc5lyw5M7U=");
_c1 = Home;
...
//# sourceMappingURL=src_cc4677e3._.js.map