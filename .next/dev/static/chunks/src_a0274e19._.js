...
_s(useAnalysis, "eyLwNgfcYrUmVi7h2b7uOKwtnQw=");
if (typeof globalThis.$RefreshHelpers$ === 'object' && globalThis.$RefreshHelpers !== null) {
    __turbopack_context__.k.registerExports(__turbopack_context__.m, globalThis.$RefreshHelpers$);
}
}),
...
const AnalysisPanel = ({ uploadedFiles, close })=>{
    _s();
    const { runAnalysis, isAnalyzing, results, error } = (0, __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$hooks$2f$useAnalysis$2e$ts__$5b$app$2d$client$5d$__$28$ecmascript$29$__["useAnalysis"])();
...
_s(AnalysisPanel, "Rm3gbgivFp0iOp52pWYS/baMCwk=", false, function() {
    return [
...
//# sourceMappingURL=src_a0274e19._.js.map