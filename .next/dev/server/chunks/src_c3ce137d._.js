...
"[project]/src/app/api/legend/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        const categories = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$prisma$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["default"].polaRuangRevisiRtrw.findMany({
            distinct: [
                'namobj'
            ],
            select: {
        ...
        console.error('Error fetching legend categories:', error);
...
//# sourceMappingURL=src_c3ce137d._.js.map