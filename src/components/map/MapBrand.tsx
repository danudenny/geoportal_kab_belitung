...
const MapBrand: React.FC = () => {
    return (
        <div className="absolute top-6 left-6 z-10 flex items-center gap-4 bg-slate-900/80 backdrop-blur-md p-3 pr-6 rounded-md border border-slate-700/50 shadow-2xl select-none">
            <Image
